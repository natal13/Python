...
point_cloud = lp.read("buk15bufor.las")
...
plane_model, inliers = pcd.segment_plane(distance_threshold = 0.1 , ransac_n = 30, num_iterations = 1000)
...
cl, ind = plane_pcd.remove_statistical_outlier(nb_neighbors=30, std_ratio=2)
